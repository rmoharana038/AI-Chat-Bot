...
const PROMOTIONAL_MESSAGE = `Hey dear! 🌴✈️ Planning your next dream vacation? 🏖️✨

Explore incredible holiday deals with Apni Holidays — Your Dream Holiday & Tour Packages from India! 🇮🇳🎒

🔥 Featured Tour Deals:
🏔️ KASHMIR (4N/5D) – BIG OFFER DEAL
🏝️ Andaman Nicobar (5 Days 4 Nights)
✨ Thailand (4 Nights 5 Days)
🌊 Budget Bliss in Phuket
🌆 Thailand Explorer: City & Coast Edition

Grab the best holiday packages & custom itineraries now:
👉 https://apniholidays.com/

Let me know which destination is on your travel bucket list! 💖✈️`;
...
async function runBroadcast() {
  ...
  console.log(`\n📊 Target Audience for Apni Holidays Promotion:`);
  ...
  console.log(`\n========================================`);
  console.log(`🎉 Apni Holidays Broadcast Completed!`);
  ...
  // Save report
  fs.writeFileSync(
    path.resolve(__dirname, 'broadcast_apni_holidays_report.json'),
